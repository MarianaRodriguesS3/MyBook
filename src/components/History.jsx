...
import { getAllHistoryEntries, deleteHistoryEntry, } from "../services/historyService";
                ...
                {entries.length > 0 && (
                    <div className="history-grid">
                        {entries.map((entry) => (
                            <div
                                key={entry.id}
                                className="history-item" onMouseDown={() => startPress(entry.id)}
                            ...
                            >
                                <div
                                    className="history-open" title={entry.fileName} role="button" tabIndex={0}
                                ...
                                {deleteMode === entry.id && (
                                    <button
                                        type="button" className="delete-button" onClick={() => handleDelete(entry.id)}
                                        aria-label="Excluir"
                                    >
